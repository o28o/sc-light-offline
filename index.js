...
function buildSutta(slug) {
  ...
  const translationResponse = fetch(
    `https://find.dhamma.gift/suttacentral/sc-data/sc_bilara_data/translation/en/sujato/sutta/${parseSlug(
      slug
    )}_translation-en-sujato.json`
  ).then(response => response.json());
  const htmlResponse = fetch(
    `https://find.dhamma.gift/suttacentral/sc-data/sc_bilara_data/html/pli/ms/sutta/${parseSlug(
      slug
    )}_html.json`
  ).then(response => response.json());
